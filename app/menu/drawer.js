...
window.showAbout = function () {
  ...
  openModal(`
    ...
    <div class="settings-row"><span><b>About Indoone</b><small>Securely generate and manage time-based one-time passwords for your accounts.</small></span></div>
    <div class="settings-row"><span><b>Version</b><small>1.0.0</small></span></div>
    <div class="settings-row"><span><b>Security</b><small>Encrypted local vault • Firebase account protection</small></span></div>
    <div class="settings-row"><span><b>Sync</b><small>Secure cloud sync across your signed-in devices</small></span></div>
    <div class="settings-row"><span><b>OTP Standard</b><small>TOTP • 6/8 digits • SHA-1 / SHA-256 / SHA-512</small></span></div>
    <div class="settings-row"><span><b>Account Storage</b><small>Cloud synced with your Indoone account</small></span></div>
    <div class="settings-row"><span><b>Legal</b><small>Privacy Policy • Terms of Service</small></span></div>
    <div class="settings-row"><span><b>Licenses</b><small>Open Source Licenses</small></span></div>
    <p style="text-align:center;margin:12px 0 2px;color:#8a8492;font-size:10px">© 2026 Indoone</p>
  `);
};
